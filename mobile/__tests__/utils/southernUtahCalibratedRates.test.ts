...
describe('builderBudgetBarometer', () => {
  ...
  it('keeps framing mat/lab from local bid lines blended with national', () => {
    ...
    expect(calibrated.labor).toBeGreaterThan(9);
    expect(calibrated.labor).toBeLessThan(18);
    expect(calibrated.material).toBeCloseTo(
      13.78 * BUILDER_BUDGET_BAROMETER_LOCAL_WEIGHT +
