...
export const TRADE_MEASUREMENT_REGISTRY: Record<string, TradeMeasurementProfile> = {
  ...
  exterior_doors: profile('exterior_doors', ['ea', 'ls'], {
    preferredPrimaryUnits: ['ea'],
    allowedPricingUnits: ['ea', 'ls'],
    canUseLivingSfAsPricing: false,
    missingQuantityBehavior: 'needs_count',
  ...
  sliding_doors: profile('sliding_doors', ['ea', 'ls'], {
    preferredPrimaryUnits: ['ea'],
    allowedPricingUnits: ['ea', 'ls'],
    canUseLivingSfAsPricing: false,
    missingQuantityBehavior: 'needs_count',
  ...
  interior_doors: profile('interior_doors', ['ea', 'ls'], {
    preferredPrimaryUnits: ['ea'],
    allowedPricingUnits: ['ea', 'ls'],
    canUseLivingSfAsPricing: false,
    missingQuantityBehavior: 'needs_count',
  ...
  garage_doors: profile('garage_doors', ['ea', 'ls'], {
    preferredPrimaryUnits: ['ea'],
    allowedPricingUnits: ['ea', 'ls'],
    canUseLivingSfAsPricing: false,
    missingQuantityBehavior: 'needs_count',
  ...
  garage_door_openers: profile('garage_door_openers', ['ea', 'ls'], {
    preferredPrimaryUnits: ['ea'],
    allowedPricingUnits: ['ea', 'ls'],
    canUseLivingSfAsPricing: false,
    missingQuantityBehavior: 'needs_count',
