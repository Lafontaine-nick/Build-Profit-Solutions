...
const DEPENDENCIES: DependencyDefinition[] = [
  ...
  { key: 'fixtures_need_rough_or_existing', label: 'Plumbing rough-in or existing connections', sourceScopeKeys: ['plumbing_trim', 'sink_faucet', 'toilet', 'vanity'], requiredScopeKeys: ['plumbing_rough'], severity: 'info', message: 'Fixture installation should confirm rough-in is existing or separately priced.' },
