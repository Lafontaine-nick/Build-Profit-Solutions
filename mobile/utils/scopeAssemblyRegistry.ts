...
const ASSEMBLIES: AssemblyDefinition[] = [
  ...
  },
  {
    ...
    optionalComponents: [
      ...
      c('opening_trim_finish', 'Opening trim & finish', ['trim_finish'], false, true),
  ...
  },
  {
    ...
    trade: 'plumbing',
    applicableScopeKeys: ['plumbing_trim', 'sink_faucet', 'garbage_disposal', 'toilet', 'vanity'],
...
const OVERLAPS: ScopeOverlapDefinition[] = [
  ...
  {
    key: 'openings_trim_finish_carpentry',
    componentKey: 'opening_casing',
    componentLabel: 'Opening casing/trim',
    relatedScopeKeys: ['trim_finish', 'interior_trim', 'trim', 'trim_paint'],
    severity: 'review',
    message: `Opening trim & finish may overlap with whole-house finish carpentry or painted trim lines.${OVERLAP_REVIEW_SUFFIX}`,
    resolutionOptions: [
      'Confirm opening trim only',
      'Use whole-house trim package',
      'Keep paint separate',
    ],
  },
  ...
  { key: 'plumbing_rough_fixtures', componentKey: 'fixture_connections', componentLabel: 'Fixture connections/testing', relatedScopeKeys: ['plumbing_rough', 'plumbing_trim', 'sink_faucet', 'garbage_disposal', 'toilet', 'vanity'], severity: 'review', message: `Plumbing rough-in and fixtures may overlap on fixture connections, valves, trim, or testing.${OVERLAP_REVIEW_SUFFIX}`, resolutionOptions: ['Confirm rough-in stops at stub-outs', 'Confirm fixture install includes trim'] },
...
const DEPENDENCIES: DependencyDefinition[] = [
  ...
  { key: 'fixtures_need_rough_or_existing', label: 'Plumbing rough-in or existing connections', sourceScopeKeys: ['plumbing_trim', 'sink_faucet', 'garbage_disposal', 'toilet', 'vanity'], requiredScopeKeys: ['plumbing_rough'], severity: 'info', message: 'Shower/tub rough-in is on Plumbing rough-in. Toilet and vanity/lav relocations are priced on their own fixture lines — confirm wet-area points only here.' },
...
const PROJECT_TEMPLATES: ProjectScopeTemplate[] = [
  ...
  },
  {
    ...
    requiredScopeGroups: [
      ...
      req('plumbing', 'Plumbing modifications', ['plumbing_rough', 'plumbing_trim', 'sink_faucet', 'garbage_disposal']),
  ...
  },
  {
    ...
    requiredScopeGroups: [
      ...
      req('plumbing', 'Plumbing', ['plumbing_rough', 'plumbing_trim', 'sink_faucet', 'garbage_disposal', 'toilet', 'vanity']),
  ...
  { key: 'plumbing_only', projectContexts: ['plumbing', 'plumbing_only'], requiredScopeGroups: [req('plumbing', 'Plumbing scope', ['plumbing_rough', 'plumbing_trim', 'sink_faucet', 'garbage_disposal', 'toilet', 'vanity'])] },
