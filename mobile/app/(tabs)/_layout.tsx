...
export default function TabLayout() {
  ...
  return (
      ...
      screenOptions={({ route }) => ({
        ...
        // Pill layout & positioning (optical balance: icon stack vs label)
        tabBarStyle: {
          position: 'absolute',
          bottom: 22,
          left: 20,
        ...
        tabBarIcon: ({ focused }) => {
          // Center Assistant — circular gradient fill, star always filled (spec)
          ...
          const iconProps = { focused, darkMode, size: 26 };
