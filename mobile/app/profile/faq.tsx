...
const faqData: FAQItem[] = [
  ...
  // Billing
  {
    ...
    answer:
      'You can upgrade, downgrade, or cancel anytime—no contracts. We offer three subscription plans: Basic ($45/month), Professional ($89/month), and Business ($179/month). Each plan includes different features and limits, and you can change your plan at any time from your Profile settings.',
    category: 'billing',
  },
  {
    id: '8',
