...
const { requireRevenueCatEntitlement } = require('../middleware/requireRevenueCatEntitlement');

/**
 * POST /api/ai/dashboard-insights
 * Generate AI insights and next steps for the user's dashboard
 */
router.post('/dashboard-insights', authenticateToken, requireRevenueCatEntitlement, async (req, res) => {
  try {
