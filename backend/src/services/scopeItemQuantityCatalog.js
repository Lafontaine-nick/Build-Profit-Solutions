...
const CHECKLIST_ITEM_QUANTITY_RULES = {
  ...
  demo_clearing: {
    defaultUnit: "sqft",
    allowedUnits: ["sqft", "allowance", "lump_sum"],
    measurementKey: "demoClearingSqft",
    requiresUserQuantity: true,
    pricingMethod: "unit_rate",
    quantityHelper: "Enter landscape clearing / removal sqft.",
    missingMessage: "Enter landscape clearing sqft or pricing.",
  },
  grading: {
    defaultUnit: "sqft",
    allowedUnits: ["sqft", "cy", "allowance", "lump_sum"],
    measurementKeys: ["gradingSqft", "floorAreaSqft"],
    pricingBasisMeasurementKey: "gradingSqft",
    requiresUserQuantity: true,
    pricingMethod: "unit_rate",
    quantityHelper:
      "Finish/rough grading is usually priced by sqft; use CY for mass cut/fill.",
    missingMessage: "Enter grading sqft, CY, or pricing.",
  },
  soil_prep: {
    defaultUnit: "sqft",
    allowedUnits: ["sqft", "allowance", "lump_sum"],
    ...
    missingMessage: "Enter soil preparation sqft or pricing.",
  },
  irrigation: {
    defaultUnit: "each",
    allowedUnits: ["each", "allowance", "lump_sum"],
    ...
    requiresUserQuantity: true,
    pricingMethod: "unit_rate",
    quantityHelper: "Enter irrigation zone count, allowance, or lump sum.",
    missingMessage: "Enter irrigation zones or pricing.",
  },
  drainage: {
    defaultUnit: "lf",
    allowedUnits: ["lf", "allowance", "lump_sum"],
    ...
    requiresUserQuantity: true,
    pricingMethod: "unit_rate",
    quantityHelper: "Enter landscape drainage LF.",
    missingMessage: "Enter drainage LF or pricing.",
  },
  landscape_lighting: {
    defaultUnit: "each",
    allowedUnits: ["each", "allowance", "lump_sum"],
    ...
    requiresUserQuantity: true,
    pricingMethod: "each",
    quantityHelper: "Enter landscape light count or allowance.",
    missingMessage: "Enter landscape light count or pricing.",
  },
  sod_turf: {
    defaultUnit: "sqft",
    allowedUnits: ["sqft", "allowance", "lump_sum"],
  ...
  concrete_edging: {
    ...
    requiresUserQuantity: true,
    pricingMethod: "unit_rate",
    quantityHelper: "Enter landscape edging LF.",
    missingMessage: "Enter edging LF.",
  },
  rock: {
    defaultUnit: "sqft",
  ...
  interior_door_install: {
    ...
    missingMessage: "Enter interior door installation count.",
  },
  door_casing_install: {
    defaultUnit: "each",
    allowedUnits: ["each", "allowance", "lump_sum"],
    requiresUserQuantity: true,
    pricingMethod: "each",
    quantityHelper: "Enter door casing installation count.",
    missingMessage: "Enter door casing installation count.",
  },
  window_install: {
    defaultUnit: "each",
    allowedUnits: ["each", "allowance", "lump_sum"],
    ...
    missingMessage: "Enter window installation count.",
  },
  cabinet_paint: {
    defaultUnit: "lf",
