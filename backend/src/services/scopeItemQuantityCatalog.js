...
const CHECKLIST_ITEM_QUANTITY_RULES = {
  ...
  garbage_disposal: {
    ...
    requiresUserQuantity: true,
    pricingMethod: 'each',
    quantityHelper: 'Pick reuse/install or replace/install, then enter disposal count or allowance.',
  ...
  pour_foundation: {
    ...
    requiresUserQuantity: true,
    pricingMethod: 'unit_rate',
    quantityHelper: 'Concrete material and placement only in CY. Excavation, forms, reinforcement, waterproofing, and structural accessories are separate.',
