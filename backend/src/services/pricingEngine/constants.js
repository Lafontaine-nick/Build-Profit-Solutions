...
const NATIONAL_TRADE_AVERAGES = {
  ...
  landscaping: {
    ...
    material: 3,
    labor: 5,
    materialLabel: "Landscape materials allowance",
  ...
  landscape_clearing: {
    ...
    material: 0.4,
    labor: 2.5,
    materialLabel: "Clearing equipment, protection & disposal",
    laborLabel: "Landscape clearing labor",
  },
  landscape_grading: {
    unit: "sqft",
    material: 0.3,
    labor: 1.2,
    materialLabel: "Grading equipment & aggregate allowance",
    laborLabel: "Landscape grading labor",
  },
  landscape_soil_prep: {
    unit: "sqft",
    material: 1.2,
    labor: 1.5,
    materialLabel: "Soil, compost & amendments",
    laborLabel: "Soil preparation labor",
  },
  landscape_sod: {
    unit: "sqft",
    material: 0.6,
    labor: 1.4,
    materialLabel: "Sod, seedbed & starter materials",
    laborLabel: "Sod installation labor",
  },
  landscape_artificial_turf: {
    unit: "sqft",
    material: 5.5,
    labor: 4,
    materialLabel: "Artificial turf system materials",
    laborLabel: "Artificial turf installation labor",
  },
  landscape_pavers: {
    unit: "sqft",
    material: 5,
    labor: 10,
    materialLabel: "Paver, bedding & joint materials",
    laborLabel: "Paver installation labor",
  },
  landscape_rock: {
    unit: "ton",
    material: 80,
    labor: 35,
    materialLabel: "Decorative rock material",
    laborLabel: "Rock placement labor",
  },
  landscape_mulch: {
    unit: "ton",
    material: 45,
    labor: 35,
    materialLabel: "Mulch material",
    laborLabel: "Mulch installation labor",
  },
  landscape_plants: {
    unit: "each",
    material: 35,
    labor: 25,
    materialLabel: "Plant / shrub material allowance",
    laborLabel: "Planting labor",
  },
  landscape_trees: {
    unit: "each",
    material: 250,
    labor: 175,
    materialLabel: "Tree material allowance",
    laborLabel: "Tree planting labor",
  },
  landscape_boulders: {
    unit: "each",
    material: 125,
    labor: 150,
    materialLabel: "Landscape boulder material",
    laborLabel: "Boulder placement labor",
  },
  landscape_edging: {
    unit: "lf",
    material: 2,
    labor: 6,
    materialLabel: "Landscape edging materials",
    laborLabel: "Landscape edging labor",
  },
  landscape_retaining_wall: {
    unit: "lf",
    material: 35,
    labor: 45,
    materialLabel: "Retaining wall system materials",
    laborLabel: "Retaining wall installation labor",
  },
  landscape_drainage: {
    unit: "lf",
    material: 12,
    labor: 18,
    materialLabel: "Drainage pipe, fabric & aggregate",
    laborLabel: "Landscape drainage labor",
  },
  landscape_irrigation: {
    unit: "each",
    material: 250,
    labor: 175,
    materialLabel: "Irrigation zone materials",
    laborLabel: "Irrigation installation labor",
  },
  landscape_lighting: {
    unit: "each",
    material: 125,
    labor: 125,
    materialLabel: "Landscape light, transformer & wire materials",
    laborLabel: "Landscape lighting installation labor",
  },
  other: {
    unit: "sqft",
    material: 35,
