...
const PRICING_RANGE_CATALOG = {
  ...
  shower_tile: {
    ...
    notes: 'Shower wall tile material and vertical setting labor only — not waterproofing or shower floor.',
  },
  shower_floor_tile: {
    ...
    notes: 'Shower floor tile material and setting labor only — not pan, waterproofing, or drain assembly.',
  },
  floor_tile: {
