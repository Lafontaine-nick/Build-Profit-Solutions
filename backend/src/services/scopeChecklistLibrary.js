...
const CHECKLIST_TEMPLATES = {
  ...
  flooring: {
    ...
    items: [
      ...
      },
      {
        ...
        inputType: 'yes_no',
        label: 'New flooring',
        helperText: 'New flooring material and installation labor when the product type is not yet specified.',
        category: 'flooring',
      },
      {
        id: 'flooring_lvp',
      ...
      },
      {
        ...
        inputType: 'yes_no',
        label: 'Underlayment',
        helperText: 'Underlayment material and installation beneath the selected flooring.',
        category: 'flooring',
      },
      {
        id: 'moisture_barrier',
      ...
      },
      {
        ...
        helperText: 'Transition strips, reducers, thresholds, and related installation.',
        category: 'trim',
      },
      {
        id: 'quarter_round',
  ...
  concrete: {
    ...
    items: [
      ...
      { id: 'site_prep', inputType: 'yes_no', label: 'Basic subgrade prep / grading', category: 'sitework' },
      { id: 'excavation', inputType: 'yes_no', label: 'Excavation / soil movement', category: 'sitework' },
      ...
      { id: 'pour_foundation', inputType: 'yes_no', label: 'Footing / foundation concrete pour', category: 'pour' },
      { id: 'complex_forming', inputType: 'yes_no', label: 'Complex forming', category: 'pour' },
      { id: 'concrete_sealer', inputType: 'yes_no', label: 'Concrete sealer', category: 'finish' },
      { id: 'decorative_finish', inputType: 'yes_no', label: 'Decorative finish', category: 'finish' },
      { id: 'additional_haul_off', inputType: 'yes_no', label: 'Additional haul-off / disposal', category: 'closeout' },
    ],
  },
  ...
  ground_up: {
    ...
    items: [
      ...
      { id: 'stucco', inputType: 'yes_no', label: 'Stucco / exterior wall finish', helperText: 'Exterior wall surface SF for material and labor.', category: 'exterior' },
      { id: 'exterior', inputType: 'yes_no', label: 'Exterior Envelope', helperText: 'Planning comparison only — price roofing, openings, and stucco separately.', category: 'exterior' },
      { id: 'mep_rough', inputType: 'yes_no', label: 'MEP rough-in', helperText: 'Planning comparison only — price plumbing / electrical / HVAC trades separately.', category: 'mep' },
      ...
      { id: 'countertops', inputType: 'yes_no', label: 'Counters', category: 'finishes' },
      { id: 'tile_flooring', inputType: 'yes_no', label: 'Tile & flooring', category: 'finishes' },
      { id: 'floor_tile', inputType: 'yes_no', label: 'Bath floor tile', category: 'finishes' },
      { id: 'shower_tile', inputType: 'yes_no', label: 'Shower wall tile', category: 'finishes' },
      { id: 'shower_floor_tile', inputType: 'yes_no', label: 'Shower floor tile', category: 'finishes' },
      {
        id: 'glass_door',
        inputType: 'yes_no',
        label: 'Shower doors',
...
const CHECKLIST_YES_HINTS = {
  ...
  glass_door: /\b(shower\s+door|glass\s+shower|shower\s+doors?\s*(?:&|and)\s*mirrors?)\b/,
  ...
  stucco: /\b(stucco|exterior\s+wall\s+finish|exterior\s+plaster|synthetic\s+stucco|efis|eifs)\b/,
