...
const CHECKLIST_TEMPLATES = {
  ...
  ground_up: {
    ...
    items: [
      ...
      { id: 'windows_doors', inputType: 'yes_no', label: 'Windows & doors', helperText: 'Opening count for material and labor.', category: 'exterior' },
      ...
      { id: 'exterior', inputType: 'yes_no', label: 'Exterior Envelope', helperText: 'Planning comparison only — price roofing, windows/doors, and stucco separately.', category: 'exterior' },
