...
const SCOPE_ALIAS_OVERRIDES = {
  ...
  grading: ["grading", "grade site", "grade yard", "grade"],
  soil_prep: ["soil prep", "soil preparation", "soil amendment", "topsoil"],
  drainage: ["landscape drainage", "french drain", "drain tile"],
  landscape_lighting: [
    "landscape lighting",
    "landscape lights",
    "path lights",
  ...
  plants: ["plants", "plant", "shrubs", "shrub"],
  concrete_edging: ["edging", "landscape edging", "concrete edging"],
